...
import re
import io
import gc  # Biblioteca para gerenciar memória

st.set_page_config(page_title="Processador de Ponto", layout="centered")

st.title(" Conversor dos Registros de Ponto")
st.write("Suba o PDF para extrair os dados. Otimizado para arquivos grandes.")
...
if uploaded_file is not None:
    if st.button("Processar Arquivo"):
        ...
        # Abre o arquivo em modo binário (mais eficiente)
        with pdfplumber.open(uploaded_file) as pdf:
            ...
            for i, pagina in enumerate(pdf.pages):
                ...
                # Processamento da área de batidas
                ...
                pagina.flush_cache() # Limpa os dados dessa página da memória
                if i % 20 == 0:      # A cada 20 páginas, força a coleta de lixo
                    gc.collect()
