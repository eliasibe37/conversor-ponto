...
# 1. ESTILIZAÇÃO CSS AVANÇADA (Layout Padronizado Parvi/RCR)
st.markdown("""
    <style>
        ...
        /* Estilo dos Cards Padronizado em Teal/Verde Esmeralda */
        .card {
...
with col1:
    st.markdown("""
        <div class="card">
            <h3>Sem Movimento</h3>
            <p>Visão geral e painel de indicadores relacionados, controle de jornadas e acompanhamento operacional da equipe.</p>
        </div>
    """, unsafe_allow_html=True)
...
with col2:
    st.markdown("""
        <div class="card">
            ...
            <p>Tratamento de arquivos TXT de ponto. Filtragem por filiais, tratamento de horas extras, adicionais e folgas.</p>
        </div>
    """, unsafe_allow_html=True)
